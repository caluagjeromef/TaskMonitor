<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-dark-primary navbar-dark px-3">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
    ...
    <?php endif; ?>
      <li class="nav-item">
        <a class= "d-flex pt-2 text-white"  href="./" role="button"> <large><b><?php echo $_SESSION['system']['name'] ?></b></large></a>
      </li>
    </ul>
